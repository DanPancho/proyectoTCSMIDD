...
public class Activos implements Serializable {
	...
	public Activos(Long id_activo, String area, String edificio, String piso, String tipo, String hostname,
			String direccion_mac, String direccion_ip, boolean reservada_ip, boolean borrado_logico, boolean estado,
			Date fecha_registro, Date fecha_entrega, Date fecha_devolucion, String id_ultimatix) {
	...
	public String toString() {
		return "Activos [id_activo=" + id_activo + ", area=" + area + ", edificio=" + edificio + ", piso=" + piso
				+ ", tipo=" + tipo + ", hostname=" + hostname + ", direccion_mac=" + direccion_mac + ", direccion_ip="
				+ direccion_ip + ", reservada_ip=" + reservada_ip + ", borrado_logico=" + borrado_logico + ", estado="
				+ estado + ", fecha_registro=" + fecha_registro + ", fecha_entrega=" + fecha_entrega
				+ ", fecha_devolucion=" + fecha_devolucion + ", id_ultimatix=" + id_ultimatix + "]";
	}
