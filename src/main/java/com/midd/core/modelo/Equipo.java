...
public class Equipo {
    ...
    public Equipo(Long id_asi, Long tipo_equipo_asi, String nombre_equipo_asi, String nombre_lider,
    ...
    public Long getTipo_equipo_asi() {
        return tipo_equipo_asi;
    }

    public void setTipo_equipo_asi(Long tipo_equipo_asi) {
        this.tipo_equipo_asi = tipo_equipo_asi;
    }
